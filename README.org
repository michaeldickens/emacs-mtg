...
#+BEGIN_EXAMPLE
  ...
  :MTG_FORMAT: standard
  :END:
  If you open this link --> [[mtg:Black Lotus]], the card will appear with a red tint because it's illegal in Standard.
  ** My vintage cards
  :PROPERTIES:
  :MTG_FORMAT: vintage
  :END:
  [[mtg:Black Lotus][Black Lotus]] is legal in Vintage, so here it will appear with no tint.
#+END_EXAMPLE
